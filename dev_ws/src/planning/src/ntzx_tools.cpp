...
#define Lat_Origin   32.02874010388		      // 地面平面坐标系原点的纬度，南通
#define Lon_Origin    120.91914932024001   // 地面平面坐标系原点的经度
#define Re  6378137
#define Rn  6356755
...
double ntzx_GPS_length(double lonti1,double lati1,double lonti2,double lati2)
{
    ...
    printf("lon2=%.9f,lon1=%.9f,lat2=%.9f,lat1=%.9f",lonti2,lonti1,lati2,lati1);
    printf("%f",length);
    return length;
