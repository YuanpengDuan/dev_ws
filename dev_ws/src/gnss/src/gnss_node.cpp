   ...
   void timer_callback()
    {
        ...
        /*经度数据发布*/
        message.lon= g_gps_data.lon;
        RCLCPP_INFO(this->get_logger(),"lon='%.9f'",message.lon);
        /*纬度数据发布*/
        message.lat= g_gps_data.lat;
        RCLCPP_INFO(this->get_logger(),"lat='%.9f'",message.lat);
        /*航向角数据发布*/
        message.courseangle= g_gps_data.courseAngle;
        RCLCPP_INFO(this->get_logger(),"courseAngle='%.9f'",message.courseangle);
        /*俯仰角数据发布*/
